...
/**
 * @module WCPAutoCareUpsellOfferCard
 *
...
import './WCPAutoCareUpsellOfferCard.css';
...
export function WCPAutoCareUpsellOfferCard({
  vehicle,
  vehicleSub,
  serviceName,
  discountPct,
...
WCPAutoCareUpsellOfferCard.displayName = 'WCPAutoCareUpsellOfferCard';
