...
/**
 * @module WCPDelayedDeliveryModals
 *
...
function RescheduleDeliveryModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  if (confirmed) {
    ...
    return (
      <WCPDemoModalRaw open={open} onClose={onClose} width={420}>
...
export function WCPDelayedDeliveryModals({ openModal, onClose, orderTotal }: DelayedDeliveryModalsProps) {
  return (
    <>
...
WCPDelayedDeliveryModals.displayName = 'WCPDelayedDeliveryModals';
