...
/**
 * @module WCPMaintenanceHealthCard
 *
...
import './WCPMaintenanceHealthCard.css';
...
export function WCPMaintenanceHealthCard({
  vehicle,
  mileage,
  healthScore,
  items,
        ...
        >
          {items.map((item) => {
            ...
            return (
              ...
              >
                <Tag variant="primary" color={tag.color}>
                  {tag.label}
                </Tag>
...
WCPMaintenanceHealthCard.displayName = 'WCPMaintenanceHealthCard';
