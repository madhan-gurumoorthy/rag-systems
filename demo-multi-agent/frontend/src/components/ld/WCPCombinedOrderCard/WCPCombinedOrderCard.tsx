...
import type { OrderProduct, OrderAction, ServiceDetails } from '../WCPOrderCard';
import './WCPCombinedOrderCard.css';
...
export function WCPCombinedOrderCard({ autoCare, delivery }: CombinedOrderCardProps) {
...
WCPCombinedOrderCard.displayName = 'WCPCombinedOrderCard';
