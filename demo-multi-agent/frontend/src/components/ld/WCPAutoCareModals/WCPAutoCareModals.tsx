...
import { WCPDemoModal, WCPDemoModalRaw } from '../WCPDemoModal';
import type { ServiceDetails } from '../WCPOrderCard';
import './WCPAutoCareModals.css';
...
function CheckInModal({
  ...
  return (
    <WCPDemoModalRaw open={open} onClose={onClose} width={440}>
      {confirmed ? (
...
function ViewDetailsModal({
  ...
  return (
    <WCPDemoModal open={open} onClose={onClose} title="Appointment Details" width={480}>
      <div className="ld-wcp-auto-care-modals-body">
        {/* Vehicle + services */}
...
export function WCPAutoCareModals({
  openModal,
  onClose,
  onSwitchToCheckIn,
  onSwitchToReschedule,
...
WCPAutoCareModals.displayName = 'WCPAutoCareModals';
