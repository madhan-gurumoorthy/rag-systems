 ...
 * ### Lines
 * 
 * The Line Clamp displays two lines by default. This number can be configured through the `lines` prop:
 * 
 * ```tsx
 * <LineClamp lines={3}>
 ...
 * ## FAQ
 * 
 * ### Why is `LineClamp` not truncating lines correctly?
 * 
 * `LineClamp`, due to its usage of `-webkit-line-clamp`, is only compatible with phrasing content. It will not work with multiple paragraphs or block-level elements.
 * 
 * Until `-webkit-line-clamp` property provides good support for this use case, an alternative solution must be used.
 * 
 * For more information on this issue, please refer to this [documentation](https://codepen.io/jimratliff/full/BaBzzbq).
 * 
 * ### What browsers does `LineClamp` support?
 * 
 * Can I Use reports good support for [`-webkit-line-clamp`](https://caniuse.com/css-line-clamp) on evergreen browsers. Use a polyfill (like [webkit-line-clamp](https://www.npmjs.com/package/webkit-line-clamp)) instead of `LineClamp` to support legacy browsers.
 */
