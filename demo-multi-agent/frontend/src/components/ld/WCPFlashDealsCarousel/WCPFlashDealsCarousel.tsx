...
import { WCPFlashDealsItemTile } from '../WCPFlashDealsItemTile';
import './WCPFlashDealsCarousel.css';
    ...
    <section className="ld-wcp-flash-deals-carousel-root">
      ...
      <div className="ld-wcp-flash-deals-carousel-header">
        ...
        <LinkButton
          href="#"
          size="small"
          UNSAFE_className="ld-wcp-flash-deals-carousel-viewall"
        >
          View all
        </LinkButton>
      </div>
