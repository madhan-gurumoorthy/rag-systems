...
import './WCPProductCardGrid.css';

/**
 * Maps a flag label to its correct WCPFlag variant based on Walmart design guidelines.
 */
function getFlagVariant(flag: string): WCPFlagVariant {
      ...
      <div className="ld-wcp-product-card-grid-image-area">
        ...
        {flag && (
          <div className="ld-wcp-product-card-grid-flag-wrap">
            <WCPFlag label={flag} variant={flagVariant ?? getFlagVariant(flag)} />
          </div>
        )}
