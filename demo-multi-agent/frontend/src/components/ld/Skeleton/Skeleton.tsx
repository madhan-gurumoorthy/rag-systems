 ...
 * #### Is Magic
 * 
 * Use the `isMagic` prop to indicate that the Skeleton represents content that was generated or influenced by an AI agent. When enabled, `isMagic` applies "magic" styles to visually distinguish AI-generated content placeholders.
 * 
 * ```tsx
 * <Skeleton isMagic />
 * ```
 ...
 * #### Variant
 * 
 * Skeleton comes in two variants:
 * 
 * - rectangle: slightly rounded corners
 * - rounded: fully rounded corners
 * 
 * Set the variant with the `variant` prop:
 * 
 * ```tsx
 ...
 * #### Dimensions
 * 
 * Use the `height` and `width` properties to set the dimensions of Skeleton to match a screen's interface elements.
 * 
 * ```tsx
