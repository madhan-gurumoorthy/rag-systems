...
import './WCPContinueShopping.css';
...
export function WCPContinueShopping() {
    ...
    <section className="ld-wcp-continue-shopping-root">
      ...
      <div className="ld-wcp-continue-shopping-header">
        ...
        <LinkButton
          href="#"
          size="small"
          UNSAFE_className="ld-wcp-continue-shopping-see-all"
        >
          See all
        </LinkButton>
      </div>
          ...
          >
            ...
            <div className="ld-wcp-continue-shopping-category-header">
              ...
              <LinkButton
                href="#"
                size="small"
                UNSAFE_className="ld-wcp-continue-shopping-shop-all"
              >
                Shop all
              </LinkButton>
            </div>
...
WCPContinueShopping.displayName = 'WCPContinueShopping';
