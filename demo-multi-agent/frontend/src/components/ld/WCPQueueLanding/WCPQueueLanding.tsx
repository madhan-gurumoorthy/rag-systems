...
export const WCPQueueLanding: React.FunctionComponent<WCPQueueLandingProps> = (props) => {
        ...
        <div className="ld-wcp-queuelanding-cardContent">
          <div className="ld-wcp-queuelanding-waitSection">
            <div className="ld-wcp-queuelanding-waitGroup">
              ...
              <WCPTimerView timeDisplay={timeDisplay} endTime={endTime} variant={timerVariant} size="medium" />
            </div>
...
WCPQueueLanding.displayName = 'WCPQueueLanding';
