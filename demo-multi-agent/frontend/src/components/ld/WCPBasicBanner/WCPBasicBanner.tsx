...
import './WCPBasicBanner.css';

export type WCPBasicBannerVariant = 'default' | 'brand' | 'inverse';

export interface WCPBasicBannerProps
...
export const WCPBasicBanner: React.FunctionComponent<WCPBasicBannerProps> = (props) => {
  const {
    icon,
...
WCPBasicBanner.displayName = 'WCPBasicBanner';
