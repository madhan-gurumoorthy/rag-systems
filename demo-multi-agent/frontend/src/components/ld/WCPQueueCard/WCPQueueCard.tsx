...
export const WCPQueueCard: React.FunctionComponent<WCPQueueCardProps> = (props) => {
  ...
  invariant(
    ...
    '`WCPQueueCard` accessibility violation. When `image` is provided, either `productImageAlt` or `description` must be set so the image has a meaningful alt.',
  );
